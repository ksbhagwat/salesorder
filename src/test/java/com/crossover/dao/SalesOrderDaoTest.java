...
public class SalesOrderDaoTest extends BaseDaoTestCase {
    @Autowired
    private SalesOrderDao salesOrderDao;
    
    
    @Test
    public void getSalesOrderBySalesOrderNumber()throws Exception {
    	SalesOrder salesOrder= null;
    	try{
			salesOrder = salesOrderDao.getSalesOrderBySalesOrderNumber("11l");
		}catch(OrderNumberNotExistsException cnnee){
			log.debug("SalesOrder Does not exist with Number : "+11);
		}
    }
    ...
    public void testSaveSalesOrder() throws Exception {
    	SalesOrder salesOrder = null;
    	SalesOrderDetails orderDetail = null;
    	Customer customer = null;
    	try {
    		salesOrder = new SalesOrder();
    		orderDetail = new SalesOrderDetails();

    		customer = new Customer();
    		customer.setCode("C");
        	customer.setName("TESt");
        	customer.setCreditLimit(12d);
        	customer.setCurrentCredit(13d);
        	customer.setPhoneNumber1("111");
        	customer.setPhoneNumber2("222");
        	
        	orderDetail.setId(1l);
        	orderDetail.setQuantity(111);
        	orderDetail.setTotalPrice(1123d);
        	orderDetail.setUnitPrice(111d);
        	

    		salesOrder.getCustomerSet().add(customer);
    		salesOrder.getOrderSet().add(orderDetail);
    		salesOrder.setOrderNumber("1");
    		salesOrder.setTotalPrice(111d);
